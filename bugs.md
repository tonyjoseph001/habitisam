General App
-Swipe back button is not working, its actually app is closing when swiping back, it should go to previous screen
...
- progress circle need to redesign becauses all the components not fiting entire screen, need to redesign it
- There is not way to exit from this page, there is no back button
